trait_opt <- function(P50,
  ...
  for (ss in 1:n_uncer) {
    ...
    if(use_LMA_from_TLP_LS) {
      LMA_e_last = mod_LMA_intercept_sample + mod_LMA_slope_y1_sample*mod_LMA_slope_y1_sample +
    ...
    WD_e_last = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_last  + mod_WD_slope_y3_sample*slope_e_last+ 
    ...
    while (T) {
      ...
      WD_e[ss] = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_last  + mod_WD_slope_y3_sample*slope_e_last+ 
        mod_WD_slope_y2_sample*Ks_e_last
  ...
  return_vals <- list("P50_e"=P50_e,"TLP_e"=TLP_e,"LMA_e"=LMA_e,"WD_e"=WD_e,"slope_e"=slope_e,'LS_e'= LS_e_start,'Ks_e'=Ks_e)
