opt_test_plots_KsTLP <- function(trait,
                                 LS_e_mean,
                                 LS_e_5perc,
                                 LS_e_95perc,
                                 LS_e,
  ...
  plot(trait$LS,trait$P50,pch=16,xlab="LS",ylab="P50",main="LS vs P50")
  points(LS_e[,1],P50_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(LS_e[,1],P50_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(LS_e[,1],P50_e_5perc,col="green",pch=16)
  points(LS_e[,1],P50_e_95perc,col="green",pch=16)
  
  plot(trait$P50,trait$Ks,pch=16,xlab="P50",ylab="LS",main="P50 vs LS")
  points(P50_e[,1],LS_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(P50_e[,1],LS_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(P50_e[,1],LS_e_5perc,col="green",pch=16)
  points(P50_e[,1],LS_e_95perc,col="green",pch=16)
  
  plot(trait$TLP,trait$slope,pch=16,xlab="TLP",ylab="slope",main="TLP vs slope")
  points(TLP_e,slope_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(TLP_e,slope_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(TLP_e,slope_e_5perc,col="green",pch=16)
  points(TLP_e,slope_e_95perc,col="green",pch=16)
  
  plot(trait$slope,trait$TLP,pch=16,xlab="slope",ylab="TLP",main="slope vs TLP")
  points(slope_e[,1],TLP_e,col="blue",pch=16) # Using central estimate coefficients
  points(slope_e_mean,TLP_e,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(slope_e_5perc,TLP_e,col="green",pch=16)
  points(slope_e_95perc,TLP_e,col="green",pch=16)
  ...
  points(TLP_e,WD_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(TLP_e,WD_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(TLP_e,WD_e_5perc,col="green",pch=16)
  points(TLP_e,WD_e_95perc,col="green",pch=16)
  
  plot(trait$WD,trait$TLP,pch=16,xlab="WD",ylab="TLP",main="WD vs TLP")
  points(WD_e[,1],TLP_e,col="blue",pch=16) # Using central estimate coefficients
  points(WD_e_mean,TLP_e,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(WD_e_5perc,TLP_e,col="green",pch=16)
  points(WD_e_95perc,TLP_e,col="green",pch=16)
  ...
  points(TLP_e,LMA_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(TLP_e,LMA_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(TLP_e,LMA_e_5perc,col="green",pch=16)
  points(TLP_e,LMA_e_95perc,col="green",pch=16)
  ...
  plot(trait$LMA,trait$LS,pch=16,xlab="LMA",ylab="LS",main="LMA vs LS")
  points(LMA_e[,1],LS_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(LMA_e[,1],LS_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(LMA_e[,1],LS_e_5perc,col="green",pch=16)
  points(LMA_e[,1],LS_e_95perc,col="green",pch=16)
