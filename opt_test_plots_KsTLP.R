opt_test_plots_KsTLP <- function(trait,
  ...
  points(slope_e_mean,TLP_e[,1],col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(slope_e_5perc,TLP_e[,1],col="green",pch=16)
  points(slope_e_95perc,TLP_e[,1],col="green",pch=16)
  ...
  points(WD_e_mean,TLP_e[,1],col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(WD_e_5perc,TLP_e[,1],col="green",pch=16)
  points(WD_e_95perc,TLP_e[,1],col="green",pch=16)
  ...
  plot(trait$Ks,trait$LMA,pch=16,xlab="LS",ylab="LMA",main="Ks vs LMA")
  ...
  plot(trait$LMA,trait$Ks,pch=16,xlab="LMA",ylab="LS",main="LMA vs Ks")
  points(LMA_e[,1],Ks_e[,1],col="blue",pch=16) # Using central estimate coefficients
  points(LMA_e[,1],Ks_e_mean,col="red",pch=16) # Using mean of all bootstrapped estimates 
  points(LMA_e[,1],Ks_e_5perc,col="green",pch=16)
  points(LMA_e[,1],Ks_e_95perc,col="green",pch=16)
