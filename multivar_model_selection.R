...
P50_multivar_test <- function(trait,view_stats=FALSE, regr_type = 'lm' )  {
  ...
  if(regr_type=='lm'){#lm allows for more than 5 variables in the regression
    ...
    #P50_from_TLP_Ks_limitTLPKsWD
    P50_from_TLP_Ks_limitTLPKsWD <- sma_plot_stats(data.frame(trait$TLP,trait$Ks,trait$P50),c("TLP","Ks","P50"),nbtstrp,indin = P50_from_TLP_Ks_WD$dataused,regression_type = regr_type)
    plot(trait$P50[P50_from_TLP_Ks_limitTLPKsWD$dataused],P50_from_TLP_Ks_limitTLPKsWD$var_est,pch=16,xlab="P50",ylab="P50_est",main="P50 vs P50_est")
    ...
    all_testnames_P50 <- c("P50_from_TLP_LS_Ks_slope_WD","P50_from_TLP_LS_Ks_slope",  "P50_from_TLP_Ks_WD","P50_from_TLP_Ks","P50_from_TLP_limitTLPLS","P50_from_Ks_limitTLPKs","P50_from_TLP_LS_Ks","P50_from_TLP_LS",                          "P50_from_Ks_LS","P50_from_LS_limitTLPLS",         "P50_from_TLP_Ks_limitTLPKsWD")
    all_R2_P50 <- c(P50_from_TLP_LS_Ks_slope_WD$R,       P50_from_TLP_LS_Ks_slope$R,   P50_from_TLP_Ks_WD$R2,P50_from_TLP_Ks$R2,P50_from_TLP_limitTLPLS$R2,P50_from_Ks_limitTLPKs$R2,P50_from_TLP_LS_Ks$R2,P50_from_TLP_LS$R2,                    P50_from_Ks_LS$R2,P50_from_LS_limitTLPLS$R2,       P50_from_TLP_Ks_limitTLPKsWD$R2)
    all_R2adj_P50 <- c(P50_from_TLP_LS_Ks_slope_WD$R2adj,P50_from_TLP_LS_Ks_slope$R2adj,P50_from_TLP_Ks_WD$R2adj,P50_from_TLP_Ks$R2adj,P50_from_TLP_limitTLPLS$R2adj,P50_from_Ks_limitTLPKs$R2adj,P50_from_TLP_LS_Ks$R2adj,P50_from_TLP_LS$R2adj, P50_from_Ks_LS$R2adj,P50_from_LS_limitTLPLS$R2adj, P50_from_TLP_Ks_limitTLPKsWD$R2adj)
    all_rmse_P50 <- c(P50_from_TLP_LS_Ks_slope_WD$rmse, P50_from_TLP_LS_Ks_slope$rmse,  P50_from_TLP_Ks_WD$rmse,P50_from_TLP_Ks$rmse,P50_from_TLP_limitTLPLS$rmse,P50_from_Ks_limitTLPKs$rmse,P50_from_TLP_LS_Ks$rmse,P50_from_TLP_LS$rmse,       P50_from_Ks_LS$rmse,P50_from_LS_limitTLPLS$rmse,   P50_from_TLP_Ks_limitTLPKsWD$rmse)
    all_ndata_P50 <- c(P50_from_TLP_LS_Ks_slope_WD$ndata,P50_from_TLP_LS_Ks_slope$ndata,P50_from_TLP_Ks_WD$ndata,P50_from_TLP_Ks$ndata,P50_from_TLP_limitTLPLS$ndata,P50_from_Ks_limitTLPKs$ndata,P50_from_TLP_LS_Ks$ndata,P50_from_TLP_LS$ndata, P50_from_Ks_LS$ndata,P50_from_LS_limitTLPLS$ndata, P50_from_TLP_Ks_limitTLPKsWD$ndata)
    ...
    plot(trait$MAT[P50_from_TLP_Ks_limitTLPKsWD$dataused],trait$MAP[P50_from_TLP_Ks_limitTLPKsWD$dataused])
...
LMA_multivar_test_BE <- function(trait_BE,view_stats=FALSE, regr_type = 'lm' ) {
  ...
  # LMA from TLP and LS (same species as for LS, WD and TLP)
...
WD_multivar_test <- function(trait,view_stats=FALSE, leaf_type = NULL,regr_type = 'lm' )  {
  ...
  if(leaf_type == 'BE'){
    ...
    # DECISION for BE:  WD_from_P50_LMA_Ks
...
Ks_multivar_test <- function(trait,view_stats=FALSE, regr_type = 'lm') {
  ...
  # Ks from P50, LS limited by Ks_from_P50_LS_WD
  Ks_from_P50_LS_limitP50LSWD <- sma_plot_stats(data.frame(trait$P50,trait$LS,trait$Ks),c("P50","LS","Ks"),nbtstrp,indin=Ks_from_P50_LS_WD$dataused,regression_type = regr_type)
  plot(trait$Ks[ Ks_from_P50_LS_limitP50LSWD$dataused], Ks_from_P50_LS_limitP50LSWD$var_est,pch=16,xlab="Ks",ylab="Ks_est",main="Ks vs Ks_est")
  ...
  # Summarise statistics
  all_testnames_Ks <- c("Ks_from_P50_TLP_LS ","Ks_from_P50_LS_LMA",    "Ks_from_P50_LS_slope",   "Ks_from_P50_LS",    "Ks_from_P50_LS_WD","Ks_from_P50_LS_limitPSLSWD",          "Ks_from_P50_LS_slope_WD","Ks_from_P50_LS_limitP50LSslope",         "Ks_from_LS ",   "Ks_from_P50",      "Ks_from_LS_limitP50LS",     "Ks_from_P50_LS_limitP50LSWD")
  all_R_Ks <- c(    Ks_from_P50_TLP_LS$R,     Ks_from_P50_LS_LMA$R,    Ks_from_P50_LS_slope$R,    Ks_from_P50_LS$R,   Ks_from_P50_LS_WD$R,Ks_from_P50_LS_limitPSLSWD$R,          Ks_from_P50_LS_slope_WD$R,  Ks_from_P50_LS_limitP50LSslope$R,        Ks_from_LS$R,     Ks_from_P50$R,     Ks_from_LS_limitP50LS$R,    Ks_from_P50_LS_limitP50LSWD$R)
  all_R2adj_Ks <- c(Ks_from_P50_TLP_LS$R2adj, Ks_from_P50_LS_LMA$R2adj,Ks_from_P50_LS_slope$R2,   Ks_from_P50_LS$R2adj, Ks_from_P50_LS_WD$R2adj,Ks_from_P50_LS_limitPSLSWD$R2adj,Ks_from_P50_LS_slope_WD$R2adj, Ks_from_P50_LS_limitP50LSslope$R2adj, Ks_from_LS$R2adj, Ks_from_P50$R2adj, Ks_from_LS_limitP50LS$R2adj,Ks_from_P50_LS_limitP50LSWD$R2adj)
  all_rmse_Ks <- c( Ks_from_P50_TLP_LS$rmse,  Ks_from_P50_LS_LMA$rmse, Ks_from_P50_LS_slope$rmse, Ks_from_P50_LS$rmse,  Ks_from_P50_LS_WD$rmse,Ks_from_P50_LS_limitPSLSWD$rmse,  Ks_from_P50_LS_slope_WD$rmse, Ks_from_P50_LS_limitP50LSslope$rmse,   Ks_from_LS$rmse,  Ks_from_P50$rmse,  Ks_from_LS_limitP50LS$rmse, Ks_from_P50_LS_limitP50LSWD$rmse)
  all_ndata_Ks <- c(Ks_from_P50_TLP_LS$ndata, Ks_from_P50_LS_LMA$ndata,Ks_from_P50_LS_slope$ndata,Ks_from_P50_LS$ndata,  Ks_from_P50_LS_WD$ndata,Ks_from_P50_LS_limitPSLSWD$ndata,Ks_from_P50_LS_slope_WD$ndata,Ks_from_P50_LS_limitP50LSslope$ndata, Ks_from_LS$ndata, Ks_from_P50$ndata, Ks_from_LS_limitP50LS$ndata,Ks_from_P50_LS_limitP50LSWD$ndata)
