  ...
  for (ss in 1:n_uncer) {
    ...
    if (ss==1) { #First pass always calculates the best estimate
      if(use_LMA_from_TLP_LS) {  # BE:
        mod_LMA_intercept_sample <- LMA_from_TLP_LS_WD$mod$intercept_R #LMA_from_TLP_LS
        ...
        mod_WD_slope_y4_sample    <- WD_from_P50_slope_Ks_LMA$mod$slope_R.y4
      ...
      if(use_LMA_from_TLP_LS) {
        ...
        mod_WD_intercept_sample   <- WD_from_P50_slope_Ks_LMA$mod$boot.intercept[ss] #WD_from_P50_slope_Ks# WD_from_Ks_P50#WD_from_slope_P50slope
        mod_WD_slope_y1_sample    <- WD_from_P50_slope_Ks_LMA$mod$boot.y1[ss]
    ...
    if(use_LMA_from_TLP_LS) {
      LMA_e_last = mod_LMA_intercept_sample + mod_LMA_slope_y1_sample*TLP_e_last +
        mod_LMA_slope_y2_sample*LS_e_start +    mod_LMA_slope_y3_sample*WD_e_last
      ...
      WD_e_last = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_start  + mod_WD_slope_y2_sample*slope_e_last+ 
        mod_WD_slope_y3_sample*Ks_e_last   + mod_WD_slope_y4_sample*LMA_e_last 
      ...
      WD_e_last = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_start  + mod_WD_slope_y2_sample*slope_e_last+ 
        mod_WD_slope_y3_sample*Ks_e_last
    }
    
    Ks_e_last  = mod_Ks_intercept_sample + mod_Ks_slope_y1_sample*P50_e_start +  
      mod_Ks_slope_y2_sample* LS_e_start  +  mod_Ks_slope_y3_sample* slope_e_last  +  mod_Ks_slope_y4_sample* WD_e_last
    
    TLP_e_last = mod_TLP_intercept_sample + mod_TLP_slope_y1_sample*LS_e_start + 
      mod_TLP_slope_y2_sample*LMA_e_last + mod_TLP_slope_y3_sample*P50_e_start + mod_TLP_slope_y4_sample*slope_e_last
   ...
   #   mod_P50_slope_y3_sample*Ks_e_start + mod_P50_slope_y4_sample*slope_e_last + mod_P50_slope_y5_sample*WD_e_last
    ...
    slope_e_last = mod_slope_intercept_sample + mod_slope_slope_y1_sample*P50_e_start + 
      mod_slope_slope_y2_sample*TLP_e_last + mod_slope_slope_y3_sample*WD_e_last + mod_slope_slope_y4_sample*Ks_e_last
    ...
    while (T) {
      ...
      if(use_LMA_from_TLP_LS) {
        ...
        #   mod_LS_slope_y3_sample * Ks_e_start
        WD_e[ss] = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_start  + mod_WD_slope_y2_sample*slope_e_last+ 
          mod_WD_slope_y3_sample*Ks_e_last   + mod_WD_slope_y4_sample*LMA_e_last 
     ...
     # P50_e[ss] = mod_P50_intercept_sample + mod_P50_slope_y1_sample*TLP_e_last +  mod_P50_slope_y2_sample*LS_e_start + 
      #  mod_P50_slope_y3_sample*Ks_e_start + mod_P50_slope_y4_sample*slope_e_last + mod_P50_slope_y5_sample*WD_e_last
        ...
        Ks_e[ss] = mod_Ks_intercept_sample + mod_Ks_slope_y1_sample*P50_e_start +  mod_Ks_slope_y2_sample* LS_e_start +
