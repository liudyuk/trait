trait_opt <- function(P50,
  ...
  for (ss in 1:n_uncer) {
    ...
    if (ss==1) { #First pass always calculates the best estimate
      ...
      if(use_LMA_from_TLP_LS) {
        ...
        mod_LS_intercept_sample  <- LS_from_LMA_TLP_Ks$mod$intercept_R[ss] #LS_from_LMA TLP_Ks
        mod_LS_slope_y1_sample   <- LS_from_LMA_TLP_Ks$mod$slope_R.y1[ss] 
        mod_LS_slope_y2_sample   <- LS_from_LMA_TLP_Ks$mod$slope_R.y2[ss] 
        mod_LS_slope_y3_sample   <- LS_from_LMA_TLP_Ks$mod$slope_R.y3[ss] 
      } else {
        ...
        mod_LS_intercept_sample  <- LS_from_TLP_Ks$mod$intercept_R[ss] #LS_from_TLP_Ks
        mod_LS_slope_y1_sample   <- LS_from_TLP_Ks$mod$slope_R.y1[ss] 
        mod_LS_slope_y2_sample   <- LS_from_TLP_Ks$mod$slope_R.y2[ss] 
      }
    ...
    if(use_LMA_from_TLP_LS) {
      LMA_e_last = mod_LMA_intercept_sample +  mod_LMA_slope_y1_sample*TLP_e_last +
       ...
       LS_e_last = mod_LS_intercept_sample + mod_LS_slope_y1_sample*LMA_e_last +  mod_LS_slope_y2_sample*TLP_e_last +
         mod_LS_slope_y3_sample * Ks_e_last 
    } else {
      LMA_e_last = mod_LMA_intercept_sample + mod_LMA_slope_y1_sample*TLP_e_last
        LS_e_last = mod_LS_intercept_sample + mod_LS_slope_y1_sample*TLP_e_last +
          mod_LS_slope_y2_sample * Ks_e_last 
    }
    
    Ks_e_last  = mod_Ks_intercept_sample + mod_Ks_slope_y1_sample*P50_e_start +  
      mod_Ks_slope_y2_sample* LS_e_last  +  mod_Ks_slope_y3_sample* slope_e_last  +  mod_Ks_slope_y4_sample* WD_e_last
   ...
   #   mod_P50_slope_y3_sample*Ks_e_last + mod_P50_slope_y4_sample*slope_e_last + mod_P50_slope_y5_sample*WD_e_last
    ...
    WD_e_last = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_start  + mod_WD_slope_y3_sample*slope_e_last+ 
    ...
    while (T) {
      ...
      P50_e[ss] = mod_P50_intercept_sample + mod_P50_slope_y1_sample*TLP_e_last +  mod_P50_slope_y2_sample*LS_e_last + 
        mod_P50_slope_y3_sample*Ks_e_last + mod_P50_slope_y4_sample*slope_e_last + mod_P50_slope_y5_sample*WD_e_last
      
      Ks_e[ss] = mod_Ks_intercept_sample + mod_Ks_slope_y1_sample*P50_e_start +  mod_Ks_slope_y2_sample* LS_e_last +
      ...
      WD_e[ss] = mod_WD_intercept_sample  + mod_WD_slope_y1_sample*P50_e_start  + mod_WD_slope_y3_sample*slope_e_last+ 
        mod_WD_slope_y2_sample*Ks_e_last
  ...
  return_vals <- list("P50_e"=P50_e_start,"TLP_e"=TLP_e,"LMA_e"=LMA_e,"WD_e"=WD_e,"slope_e"=slope_e,'LS_e'= LS_e,'Ks_e'=Ks_e)
